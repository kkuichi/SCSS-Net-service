import { aD as LinkDescriptor, aV as RouteModule, L as Location, aA as MetaDescriptor, aW as unstable_MiddlewareNextFunction, aX as ServerDataFrom, a9 as unstable_RouterContextProvider, h as MiddlewareEnabled, i as AppLoadContext, aY as Pretty, aZ as GetLoaderData, a_ as Normalize, a$ as GetActionData } from 'react-router/dist/production/route-data-ByAYLHuM.js';
import { a as RouteFiles, P as Pages } from 'react-router/dist/production/register-DeIo2iHO.js';
import 'react';
